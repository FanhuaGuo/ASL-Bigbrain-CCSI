...
if ifload
    ...
    for i = 1:RepeatTimes
        ...
        origData1_null = load([Data_name '_null.1D']);
...
set(gca, 'ylim', [0.1 0.5], 'yTick', 0.1:0.2:0.5, 'FontName', 'Arial');
set(gca, 'Box', 'off');
ax = gca;
ax.YColor = 'k'; 
ax.XColor = 'k'; % 保持刻度数字
...
set(gca,'xLim',[0 8],'xTick',[1:2:7],'xTickLabel',{'R5','R10','R15','R20'}, 'FontName', 'Arial');
set(gca, 'ylim', [0.2 0.4], 'yTick', 0.2:0.2:0.4, 'FontName', 'Arial');
set(gca, 'Box', 'off');
ax = gca;
ax.YColor = 'k'; 
ax.XColor = 'k'; % 保持刻度数字
