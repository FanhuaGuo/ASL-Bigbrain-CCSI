...
figure('Color',[1 1 1],'Position',[0 0 400 200],'Units','pixels');

% CBF-score
Data_name = 'retest_Mean_PScs_bil';  
origx = load([Group_dir Data_name '.1D']);
origData1_null = load([Group_dir Data_name '_variogram.1D']);
...
NullData_path = [Group_dir DataName UniOrBil '_variogram.1D'];
...
hold on;
b = bar(1:2, PlotScore(1:2), 'FaceColor', 'white', 'EdgeColor', [255, 31, 201]/255, 'LineWidth', 2);
b = bar(3, PlotScore(3), 'FaceColor', 'white', 'EdgeColor', [0, 191, 86]/255, 'LineWidth', 2);
b = bar(4:5, PlotScore(4:5), 'FaceColor', 'white', 'EdgeColor', [19, 0, 170]/255, 'LineWidth', 2);
b = bar(6, PlotScore(6), 'FaceColor', 'white', 'EdgeColor', [0, 197, 212]/255, 'LineWidth', 2);
